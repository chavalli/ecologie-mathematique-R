...
1.    Séparez vos opérations en unités logiques thématiques. Par exemplem (i) charger, fusionner et nettoyer les données, (ii) analyser les données, (iii) créer des fichiers comme des tableaux et des figures.
:::
