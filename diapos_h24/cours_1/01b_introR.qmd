...
## Premier aperçu de R - Windows

![](images/02_R-console-windows.png)

## Premier aperçu de R - Ubuntu
...
- [Télécharger RStudio](https://posit.co/download/rstudio-desktop/){.external target="_blank"}
- R script, [Quarto](https://quarto.org/){.external target="_blank"} document ou R notebook?
