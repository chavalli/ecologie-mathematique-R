...
market %>% 
  ggplot(mapping = aes(x = fct_reorder(category, proportion), y = proportion)) + geom_col() + labs(x = "", y = "Proportion") + coord_flip() + theme_wsj(base_size = 10)
```
...
market %>% 
  ggplot(mapping = aes(x = fct_reorder(category, proportion), y = proportion)) + geom_col() + labs(x = "", y = "Proportion") + coord_flip() + theme_prism(palette = "summer", base_size = 10)
```
