...
![](images/Screenshot_2019-02-06 HEATHER KRAUSE - OpenVis Conf 2018 - YouTube.png){fig-align="center"}

<center>[Source](https://www.youtube.com/watch?v=uw1Tag08dK4&feature=youtu.be)</center>

## La question

Que voulez-vous exprimer?

![](images/Screenshot_2019-02-06 HEATHER KRAUSE - OpenVis Conf 2018 - YouTube(1).png){fig-align="center"}

<center>[Source](https://www.youtube.com/watch?v=uw1Tag08dK4&feature=youtu.be)</center>

## Causalité

![](images/causality.png){fig-align="center"}
<center>Source: Whitlock et Schluter (2020), [The Analysis of Biological Data](https://whitlockschluter3e.zoology.ubc.ca/).</center>

## Où renforcer l'avion?

Disposition des trous de balle sur les avions britanniques de retour de leur sortie durant la deuxième guerre mondiale.

![](images/IMG_20190206_154711.jpg){fig-align="center"}
<center>Source: Whitlock et Schluter (2014), [The Analysis of Biological Data](https://whitlockschluter.zoology.ubc.ca/).</center>

## Définitions

> La **statistique** est l’étude des méthodes pour mesurer des aspects de populations à partir d’échantillons et pour quantifier l'incertitude des mesures. (ma traduction de [Whitlock et Schluter (2020)](https://whitlockschluter3e.zoology.ubc.ca/)).
...
![](images/ezgif-4-7900b0e67dff.gif){width=200 fig-align="center"}
...
Peut-on utiliser une ANOVA pour comparer deux échantillons ? Si oui, les résultats sont-ils les mêmes si nous appliquons un test t ou une ANOVA ?
...
----
<font size="8">⚠️ Ne pas confondre. ⚠️</font>
----

Modèles **prédictifs**. Le modèle doit être testé sur des données qui n'ont pas servi à l'entraîner. (chapitre 13)

Modèle **explicatif**. Le modèle sert à tester des hypothèses. (chapitres 7 et 8)
...
## Types de régression linéaire multiple

Trois types :

- Méthode standard : Toutes les variables indépendantes (VI) rentrent au même temps.
- Méthode hiérarchique (sequential) : L'entrée des VI selon un ordre prédeterminé.
- Méthode statistique (Stepwise) : Entrée de VI selon un critère statistique.

## Types de régression

![](images/regression_types.png){fig-align="center" fig-width=100}

<center><small>Source : [Tabachnick et Fidell (2013) ](https://www.pearson.com/en-us/subject-catalog/p/using-multivariate-statistics/P200000003097/9780137526543)</small></center>
