...
-   Correction des liens internet et des *CheatSheets* qui ont changé d'adresse
...
-   Remplacement de certaines fonctions qui ne sont plus maintenues par leurs options plus à jour (par exemple `sample_n()` remplacé par `slice_sample()`)
